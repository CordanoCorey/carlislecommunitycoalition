...
namespace ccc.API.Features.Users
{
  ...
  public class UsersRepository : BaseRepository<CCCContext, ApplicationUser, UserModel>, IUsersRepository
  {
    private readonly UserManager<ApplicationUser> _userManager;

    public UsersRepository(CCCContext context, IMapper mapper, UserManager<ApplicationUser> userManager) : base(context, mapper)
    {
